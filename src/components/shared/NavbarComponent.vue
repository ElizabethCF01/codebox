<template>
  <div>
    <nav class="bg-zinc-800 fixed w-full z-20 top-0 start-0 flex justify-center">
      <div class="max-w-screen-2xl flex w-full flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="/logo.svg" class="h-8" alt="Codebox Logo" />
          ...
          <div class="flex items-center gap-4 relative">
            <button @click="() => (showDrop = !showDrop)">
              <img
                ...
                :src="`https://robohash.org/${'email@example.com'}.png`"
                alt=""
              />
            </button>
            <div class="font-medium text-white">
              <div>user</div>
              <div class="text-sm text-gray-400">email@example.com</div>
            </div>
        ...
        >
          <ul
            class="flex flex-col p-4 text-white md:p-0 mt-4 font-medium border border-gray-100 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:gap-3 md:mt-0 md:border-0"
          >
            <li>
              <router-link
                to="/"
